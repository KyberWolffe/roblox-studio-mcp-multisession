...
python3 -B scripts/audit_release.py \
  --archive dist/roblox-studio-mcp-v2-0.4.0-dev.3-macos-arm64.tar.gz
python3 -B scripts/prove_release.py \
  --archive dist/roblox-studio-mcp-v2-0.4.0-dev.3-macos-arm64.tar.gz \
  --checksum-file dist/roblox-studio-mcp-v2-0.4.0-dev.3-macos-arm64.tar.gz.sha256
```
